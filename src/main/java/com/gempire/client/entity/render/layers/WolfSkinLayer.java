...
public class WolfSkinLayer<E extends EntityBeastmasterWolf, M extends ModelBeastmasterWolf<E>> extends RenderLayer<EntityBeastmasterWolf, ModelBeastmasterWolf<EntityBeastmasterWolf>> {
    private RenderLayerParent<EntityBeastmasterWolf, ModelBeastmasterWolf<EntityBeastmasterWolf>> gemRenderer;

    public WolfSkinLayer(RenderLayerParent<EntityBeastmasterWolf, ModelBeastmasterWolf<EntityBeastmasterWolf>> entityRendererIn) {
    ...
    public void render(PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn, EntityBeastmasterWolf entityBeastmasterWolf, float v, float v1, float v2, float v3, float v4, float v5) {
        int gemColor = entityBeastmasterWolf.getSkinColor();
        float r = ((gemColor & 16711680) >> 16) / 255f;
        float g = ((gemColor & 65280) >> 8) / 255f;
        float b = ((gemColor & 255) >> 0) / 255f;
        VertexConsumer builder = bufferIn.getBuffer(RenderType.entityTranslucent(new ResourceLocation("gempire:textures/entity/wolf/wolf.png")));
